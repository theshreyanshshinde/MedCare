# 💊 MedCare - Medication Management for Caregivers

A centralized web application for caregivers to manage medication schedules across multiple patients with smart reminders, compliance tracking, and care team coordination.

## ✨ Features

- **Multi-Patient Profiles** - Color-coded profiles with photos for elderly parents, children, etc.
...
- **Critical Medicine Mode** - Persistent alarm until confirmed
